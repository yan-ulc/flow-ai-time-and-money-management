...
export function HomeWidgets() {
  ...
  return (
    <div className="flex flex-row lg:flex-col gap-4 overflow-x-auto lg:overflow-visible pb-4 lg:pb-0 hide-scrollbar w-full px-4 lg:px-0 snap-x snap-mandatory">
      ...
      {/* Balance Widget */}
      <div className="flex-shrink-0 w-[85vw] sm:w-[280px] lg:w-full rounded-3xl bg-gradient-to-br from-primary/10 to-blue-500/10 border border-border/50 p-5 backdrop-blur-xl snap-center">
      ...
      <div className="flex-shrink-0 w-[85vw] sm:w-[280px] lg:w-full rounded-3xl bg-background/40 border border-border/50 p-5 backdrop-blur-xl snap-center">
        <div className="flex items-center justify-between mb-4">
          <span className="text-sm font-semibold">Upcoming Payments</span>
          <span className="text-xs text-muted-foreground bg-muted/50 px-2 py-0.5 rounded-full">2 items</span>
        </div>
        ...
        <div className="flex flex-col gap-3">
          {nextSchedules.length === 0 ? (
            ...
            <div key={item._id} className="flex items-start gap-3">
              <div className="flex flex-col items-center justify-center bg-primary/10 text-primary rounded-xl p-2 min-w-[50px]">
