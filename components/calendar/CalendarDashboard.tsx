...
export function CalendarDashboard() {
  ...
  const schedulesForTomorrow = schedules.filter((s) =>
    isSameDay(new Date(s.dateTime), addDays(new Date(), 1)),
  );
  ...
  const getStatusIcon = (status: string, dateTime: number, s?: any) => {
    ...
    if (dateTime < now && status === "upcoming")
      ...
      <div className="flex items-center justify-between mb-2">
        <div>
          ...
          <p className="text-muted-foreground mt-1">
            Manage your time and upcoming activities.
          </p>
        </div>
      </div>
              ...
              <div className="mt-4 hidden lg:block">
                ...
                <div className="space-y-2 opacity-60 grayscale-[0.5]">
                  {schedulesForTomorrow.slice(0, 2).map((s) => (
                    <div
                      key={s._id}
                      className="p-3 rounded-2xl bg-muted/20 border border-border/30 text-xs flex justify-between"
                    >
                    ...
                    <div className="flex items-center gap-3 px-2">
                      ...
                      <div>
                        ...
                        <p className="text-sm font-bold text-orange-500">
                          {formatCurrency(selectedSchedule.estimatedCost)}
                        </p>
                      </div>
                    </div>
                  )}
              ...
              <div className="mt-8 flex gap-3">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    isPendingConfirmation(selectedSchedule)
                      ? "px-6 bg-muted text-muted-foreground"
                      : "w-full bg-primary text-primary-foreground shadow-xl shadow-primary/20",
                  )}
                >
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 gap-4">
              <div className="p-4 rounded-3xl bg-muted/20 border border-border/30">
                ...
                <p className="text-sm font-semibold">
                  {formatCurrency(schedule.estimatedCost || 0)}
                </p>
              </div>
              <div
                className={cn(
