...
export interface ThemeToggleProps {
  /** Variant of the top bar. Default: "icon" */
...
export function ThemeToggle({
    ...
    setTimeout(() => {
      ...
      if (typeof document !== "undefined") {
        if (next === "dark") {
          ...
          // Persist theme choice if you have a system for it
  ...
  const btnStyle: CSSProperties = {
    ...
    background: t.btnBg,
    color: t.btnText,
    boxShadow: `0 4px 12px rgba(0,0,0,0.1), 0 0 0 1px ${t.btnRing} inset`,
    zIndex: 9999,
    outline: "none",
    transition:
    ...
    return (
      <>
        {typeof document !== "undefined"
          ? createPortal(<div aria-hidden="true" style={curtainStyle} />, document.body)
          : null}
        {btn}
      </>
    );
